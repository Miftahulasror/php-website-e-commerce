...
@include('adminlte.layouts.headlink')
</head>
...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
          <li class="nav-item">
            <a class="nav-link" href="/logout">Log Out <i class="bi bi-box-arrow-right"></i></a>
          </li>
        </ul>
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
          <img src="/adminlte/img/profile.jpg" class="img-circle elevation-2" alt="User Image">
        </div>
        <div class="info">
...
@include('adminlte.layouts.footlink')
</body>
</html>
